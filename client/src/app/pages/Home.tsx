  ...
  <p className="text-lg md:text-2xl lg:text-3xl italic font-body tracking-wider leading-relaxed max-w-5xl mx-auto">
    {t('home.motto')}
      ...
      <div className="text-center py-16 px-4">
        <h1 
  className="text-4xl md:text-6xl font-serif font-bold text-amber-900 mb-2 tracking-tight whitespace-pre-line" 
  style={{ fontFamily: "'Footlight MT', 'Footlight MT Light', 'Times New Roman', serif" }}
>
  {t('home.title').replace(' FRATERNITY', '\nFRATERNITY')}
</h1>
  ...
  <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
    <div className="inline-block p-4 bg-white/10 rounded-full mb-6 backdrop-blur-sm">
      <img src={logo} alt="Logo GOC" className="h-20 w-20 md:h-24 md:w-24" />
    </div>
